...
const biddingContainer = document.querySelector("#lot-bidding h4")
...
async function generateLotDetails() {
  ...
  ${lot.bids && lot.bids.length > 0 ? `${lot.bids.slice(-1)[0].amount} by ${lot.bids.slice(-1)[0].bidderName}` : 'no bids'}
  `;
